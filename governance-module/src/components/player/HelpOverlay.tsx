  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center p-6">
      ...
      <div className="relative z-10 w-full max-w-3xl overflow-hidden rounded-3xl border border-line bg-surface shadow-card-lg animate-scale-in">
        <div className="flex items-center justify-between bg-gradient-to-l from-green-800 via-green-600 to-teal-600 px-6 py-4 text-white">
        ...
        <div className="grid grid-cols-2 gap-3 p-6">
          {items.map((it, i) => (
            <div key={i} className="flex items-center gap-3 rounded-2xl border-2 border-green-400/50 bg-surface p-3.5 shadow-card">
              <span className="grid h-11 w-11 shrink-0 place-items-center rounded-xl bg-green-500/15 text-green-700">
                {it.icon}
              </span>
