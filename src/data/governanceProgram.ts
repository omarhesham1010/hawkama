...
export const governanceIntroSlides = indexSlides([
  ...
  makeSlide({
    ...
    narration:
      'محورنا هنا هو محتويات البرنامج التدريبي. قبل ما ندخل في التفاصيل، خلونا نشوف خريطة البرنامج التدريبي، وكيف كل فصل يبني على الفصل اللي قبله. خلونا نفكك الموضوع. أول فكرة معنا هي الفصل الأول، الحوكمة التنظيمية والامتثال. ويشمل المعرفة التنظيمية، وهياكل الحوكمة، والأخلاقيات وتضارب المصالح. بعد ما تتضح البداية، ننتقل إلى الفصل الثاني، الامتثال والتدقيق والضوابط. وفيه نركز على إدارة الامتثال، ومراقبة الضوابط، والتدريب والتوعية. ثم نصل إلى الفصل الثالث، إدارة المخاطر المؤسسية. ويشمل إطار آيزو واحد وثلاثين ألف، وإدارة المخاطر والضوابط، وتحليل المخاطر. بهذا الترتيب نبدأ بتحديد من يقرر وكيف يحاسب، ثم نتأكد من التطبيق وفعالية الضوابط، وبعدها نربط المخاطر بالقرار. إذا كانت الخريطة واضحة، نبدأ الفصل الأول بإذن الله.',
    visual: '🗺️',
