        ...
        <div className="min-h-0">
          ...
          <div className="flex flex-wrap gap-1.5">
            {data.identify.options.map((opt) => {
              ...
              if (reveal) {
                if (opt.correct) cls = 'border-tealLegacy-500/60 bg-tealLegacy-500/10 text-tealLegacy-800';
              ...
              return (
                <div
                  ...
                  className={`flex min-h-[58px] items-center gap-2 rounded-xl border-2 p-2 ${
                    isRight
                      ? 'border-tealLegacy-500/50 bg-tealLegacy-500/10'
                      : isWrong
                    ...
                    <>
                      ...
                      {pathChecked && (
                        <Icon
                          ...
                          className={`h-5 w-5 ${isRight ? 'text-tealLegacy-600' : 'text-rose-500'}`}
                        />
                      )}
                    </>
                  ) : (
