...
const ZONE_STYLES = [
  'border-greenLegacy-500/50 bg-greenLegacy-500/[0.06]',
  'border-tealLegacy-500/50 bg-tealLegacy-500/[0.06]',
] as const;
  ...
  return (
    <div className="flex h-full flex-col gap-3">
                  ...
                  return (
                    <span
                      ...
                      className={`inline-flex max-w-[240px] items-center gap-1.5 rounded-lg border px-2.5 py-1.5 text-sm font-semibold ${
                        ok
                          ? 'border-greenLegacy-500/50 bg-greenLegacy-500/10 text-greenLegacy-700'
      ...
      {pool.length > 0 ? (
        ...
        <div className="rounded-xl border border-tealLegacy-500/30 bg-tealLegacy-500/[0.06] px-4 py-2.5 text-center text-base font-semibold text-ink-soft">
      ...
      {lastItem && (
        <div
          className={`rounded-xl border px-4 py-2 text-base font-semibold leading-relaxed ${
            lastCorrect ? 'border-greenLegacy-500/40 bg-greenLegacy-500/[0.06]' : 'border-rose-400/40 bg-rose-500/[0.06]'
          }`}
        >
