...
const paths: Record<IconKey, React.ReactNode> = {
  ...
  // These keys didn't exist yet at this point in the app's history (added
  // later for course/3) -- unreferenced by any pre-course/2 bag/2 data,
  // included only so IconKey's type stays satisfied. Reuse of nearby glyphs.
  license: (
    <>
      <path d="M7 3h7l4 4v14H7z" />
      <path d="M14 3v4h4" />
