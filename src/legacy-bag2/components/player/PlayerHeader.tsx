...
import { NarrationSettings } from '../../../components/audio/NarrationSettings';
...
export function PlayerHeader({
  ...
  return (
    <header className="relative z-30 bg-gradient-to-l from-greenLegacy-800 via-greenLegacy-600 to-tealLegacy-600 shadow-card-lg">
      <div className="player-header-row mx-auto flex h-16 max-w-6xl items-center gap-3 px-4">
        ...
        <div className="flex items-center gap-2 rounded-xl bg-white/10 px-3 py-1.5">
          <span className="grid h-8 w-8 place-items-center rounded-lg bg-white/90 text-greenLegacy-700">
      ...
      <div className="player-section-tabs flex items-start justify-center gap-3">
        <span className="-mt-px rounded-b-xl bg-tealLegacy-800/85 px-8 py-1 text-[13px] font-semibold text-white shadow-card">
          {sectionLabel}
        </span>
