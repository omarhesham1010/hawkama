...
export const governanceClosingSlides = indexSlides([
  ...
  makeChapterClosing({
    ...
    takeaways: [
      { title: 'حوكمة توجّه', text: 'أدوار ومسؤوليات وآليات مساءلة واضحة تقود القرار.', emoji: '🏛️' },
      { title: 'امتثال يثبت', text: 'تحويل السياسات إلى ممارسات قابلة للتحقق والقياس.', emoji: '✅' },
      { title: 'مخاطر تحمي', text: 'تقدير الاحتمالية والأثر لحماية أولويات القرار.', emoji: '🛡️' },
    ],
  }),
]);
