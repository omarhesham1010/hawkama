    ...
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-2 gap-3">
        {[true, false].map((val) => {
          ...
          let cls = val
            ? 'border-green-500/40 bg-green-500/5 text-green-700 dark:text-green-300 hover:bg-green-500/10'
            : 'border-rose-400/40 bg-rose-500/5 text-rose-700 dark:text-rose-300 hover:bg-rose-500/10';
          if (answered) {
            if (showCorrect) cls = 'border-green-500/60 bg-green-500/15 text-green-700 dark:text-green-200';
