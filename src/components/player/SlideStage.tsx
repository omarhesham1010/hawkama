...
function IntroMotionScene({
  ...
  // the best-fitting piece per unit where one exists and falling back to
  // the general training scene for units without a good thematic match.
  const licensingHeroByUnit: Record<string, string> = {
    'lic-u1-welcome': '/assets/visual-library/intro-licensing-data-records-scene.webp',
  ...
  const governance2HeroByUnit: Record<string, string> = {
    ...
    'gov2-u5-welcome': '/assets/visual-library/icon-policy-institution-shield.webp',
  };
...
// The 13 extracted icons come in two visibly different art styles -- 7 are
// rich glossy 3D icons with gold trim (pulled straight from the trainer
// guide's own standalone icon art), 6 are flat thin-line icons on pastel
// circles (cropped out of one composite diagram). Mixing the two styles in
// one shot (e.g. a 3-card goals row with one glossy icon and two flat ones)
...
const POLICY_GOV2_KEYWORD_RULES: Array<{ style: PolicyGov2Style; icon: string; terms: string[] }> = [
  ...
  { style: 'flat', icon: '/assets/visual-library/icon-question-mark-mascot.webp', terms: ['اختبر فهمك', 'صنّف الحالات', 'صنّف المواقف', 'صنّف العبارات', 'صنّف المؤشرات', 'صنّف الجهات', 'صنّف الحوادث', 'صنّف الملاحظة', 'اقلب البطاقات', 'فسّر النقطة', 'حلّل الفارق', 'قرار الاستثمار', 'صمّم الحافز', 'صمّم التسعير التفاضلي', 'اختر النموذج', 'رتّب الأولوية'] },
  { style: 'rich', icon: '/assets/visual-library/icon-patient-safety-heart-check.webp', terms: ['أولوية السلامة', 'ثقافة السلامة', 'سلامة المريض', 'الرعاية الأولية', 'الرعاية المتخصصة', 'الرعاية الثالثية', 'الرعاية الآمنة', 'جودة الرعاية', 'الأثر السريري', 'البُعد السريري', 'تحسين العمليات السريرية', 'خطأ دوائي', 'سقوط مريض', 'المخاطر الطبية', 'الأزمات الصحية الطارئة', 'تعزيز الوقاية', 'تقليل المضاعفات', 'تكامل مسار الرعاية'] },
  { style: 'flat', icon: '/assets/visual-library/icon-patient-safety-heart-check.webp', terms: ['أولوية السلامة', 'ثقافة السلامة', 'سلامة المريض', 'الرعاية الأولية', 'الرعاية المتخصصة', 'الرعاية الثالثية', 'الرعاية الآمنة', 'جودة الرعاية', 'الأثر السريري', 'البُعد السريري', 'تحسين العمليات السريرية', 'خطأ دوائي', 'سقوط مريض', 'المخاطر الطبية', 'الأزمات الصحية الطارئة', 'تعزيز الوقاية', 'تقليل المضاعفات', 'تكامل مسار الرعاية'] },
  { style: 'rich', icon: '/assets/visual-library/icon-patient-safety-team-circle.webp', terms: ['الأفراد والجماعات', 'اختيار الأعضاء', 'توزيع المهام', 'تعزيز التنسيق', 'التنسيق بين الفرق', 'التنسيق المؤسسي', 'الشخصية القيادية الحازمة', 'الشخصية الداعمة الاجتماعية', 'الشخصية المتحفظة أو القلقة', 'الأطراف', 'مقدّمو الخدمات', 'فريق التفتيش', 'فريق طبي', 'دعم تشغيلي', 'دعم إكلينيكي', 'مقدم الخدمة'] },
  { style: 'flat', icon: '/assets/visual-library/icon-policy-stakeholder-people.webp', terms: ['الأفراد والجماعات', 'اختيار الأعضاء', 'توزيع المهام', 'تعزيز التنسيق', 'التنسيق بين الفرق', 'التنسيق المؤسسي', 'الشخصية القيادية الحازمة', 'الشخصية الداعمة الاجتماعية', 'الشخصية المتحفظة أو القلقة', 'الأطراف', 'مقدّمو الخدمات', 'فريق التفتيش', 'فريق طبي', 'دعم تشغيلي', 'دعم إكلينيكي', 'مقدم الخدمة'] },
  { style: 'rich', icon: '/assets/visual-library/icon-kpi-dashboard.webp', terms: ['توظيف أنظمة بيانات السلامة', 'تنظيم البيانات', 'تكامل البيانات', 'لوحات معلومات التشغيل', 'لوحة المعلومات', 'تصوير البيانات', 'خريطة المخاطر الحرارية', 'مصفوفة المخاطر', 'قراءة المؤشر', 'المؤشر', 'مؤشرات الاحتيال', 'مؤشرات أداء', 'مؤشرات تشغيلية', 'مؤشرات مالية', 'التحديث الزمني الفوري', 'التنبؤ الكمي', 'التنبؤ النوعي'] },
  { style: 'flat', icon: '/assets/visual-library/icon-kpi-dashboard.webp', terms: ['توظيف أنظمة بيانات السلامة', 'تنظيم البيانات', 'تكامل البيانات', 'لوحات معلومات التشغيل', 'لوحة المعلومات', 'تصوير البيانات', 'خريطة المخاطر الحرارية', 'مصفوفة المخاطر', 'قراءة المؤشر', 'المؤشر', 'مؤشرات الاحتيال', 'مؤشرات أداء', 'مؤشرات تشغيلية', 'مؤشرات مالية', 'التحديث الزمني الفوري', 'التنبؤ الكمي', 'التنبؤ النوعي'] },
  { style: 'rich', icon: '/assets/visual-library/icon-failure-investigation-gear.webp', terms: ['التعلّم من الخطأ', 'الاكتشاف المبكر', 'الاحتواء الفوري', 'الأخطاء التشغيلية الكبيرة', 'إدارة الحدث', 'مخاطر الطوارئ', 'مخاطر أمن المعلومات', 'مخاطر سيبرانية', 'اختراق بيانات', 'مخاطر مصافحة العدوى', 'FMEA', 'التلاعب بالبيانات', 'الترميز التصاعدي', 'سوء الاستخدام', 'حوادث', 'حادثة', 'فارق تكلفة', 'تكرار الفحوصات دون داعٍ'] },
  { style: 'flat', icon: '/assets/visual-library/icon-failure-investigation-gear.webp', terms: ['التعلّم من الخطأ', 'الاكتشاف المبكر', 'الاحتواء الفوري', 'الأخطاء التشغيلية الكبيرة', 'إدارة الحدث', 'مخاطر الطوارئ', 'مخاطر أمن المعلومات', 'مخاطر سيبرانية', 'اختراق بيانات', 'مخاطر مصافحة العدوى', 'FMEA', 'التلاعب بالبيانات', 'الترميز التصاعدي', 'سوء الاستخدام', 'حوادث', 'حادثة', 'فارق تكلفة', 'تكرار الفحوصات دون داعٍ'] },
  { style: 'rich', icon: '/assets/visual-library/icon-quality-cycle-badge.webp', terms: ['تحسين الجودة', 'التركيز على التحسين', 'التعلم المستمر', 'التعلم الدوري', 'التعلم التفاعلي', 'استخلاص الدروس المستفادة', 'التغذية الراجعة', 'المراجعة الدورية', 'مراجعة وتحديث', 'التعافي والتقييم', 'المتابعة والتقييم المستمر', 'مراقبة مستمرة', 'مراقبة النتائج باستمرار', 'تقييم العمليات', 'تقييم المخرجات', 'تقييم الأثر', 'الهدف النهائي'] },
  { style: 'flat', icon: '/assets/visual-library/icon-quality-cycle-badge.webp', terms: ['تحسين الجودة', 'التركيز على التحسين', 'التعلم المستمر', 'التعلم الدوري', 'التعلم التفاعلي', 'استخلاص الدروس المستفادة', 'التغذية الراجعة', 'المراجعة الدورية', 'مراجعة وتحديث', 'التعافي والتقييم', 'المتابعة والتقييم المستمر', 'مراقبة مستمرة', 'مراقبة النتائج باستمرار', 'تقييم العمليات', 'تقييم المخرجات', 'تقييم الأثر', 'الهدف النهائي'] },
  { style: 'rich', icon: '/assets/visual-library/icon-policy-checklist-clipboard.webp', terms: ['الاستبيانات المعيارية', 'الاكتمال', 'قوائم التحقق', 'تصنيف الخدمات', 'تحديد الأولويات', 'اختيار التدخل الأنسب', 'وضع إجراءات وقائية', 'الإجراءات المتخذة', 'الإجراءات', 'وضع جدول زمني واضح', 'مسؤوليات', 'تحديد المسؤوليات', 'تطبيق معاملات التعقيد', 'التوزيع التدريجي', 'Define', 'Measure', 'Analyze', 'Improve', 'Control'] },
  { style: 'flat', icon: '/assets/visual-library/icon-quality-checklist-clock.webp', terms: ['الاستبيانات المعيارية', 'الاكتمال', 'قوائم التحقق', 'تصنيف الخدمات', 'تحديد الأولويات', 'اختيار التدخل الأنسب', 'وضع إجراءات وقائية', 'الإجراءات المتخذة', 'الإجراءات', 'وضع جدول زمني واضح', 'مسؤوليات', 'تحديد المسؤوليات', 'تطبيق معاملات التعقيد', 'التوزيع التدريجي', 'Define', 'Measure', 'Analyze', 'Improve', 'Control'] },
  { style: 'rich', icon: '/assets/visual-library/icon-policy-book-magnifier-research.webp', terms: ['التحقق الاستقصائي', 'قابلية التتبع', 'المصداقية', 'السلامة الزمنية', 'حفظ الأدلة', 'التقييم الأولي', 'الإغلاق والمتابعة', 'رسم تسلسل الحدث', 'تحديد العوامل المساهمة', 'تحليل السبب', 'مراجعة الوثائق', 'المقابلات والملاحظة الميدانية', 'مقارنة النتائج قبل وبعد التطبيق', 'المقارنة بالمعايير', 'المرجعية المحلية', 'المرجعية الدولية'] },
  { style: 'flat', icon: '/assets/visual-library/icon-policy-analytics-search.webp', terms: ['التحقق الاستقصائي', 'قابلية التتبع', 'المصداقية', 'السلامة الزمنية', 'حفظ الأدلة', 'التقييم الأولي', 'الإغلاق والمتابعة', 'رسم تسلسل الحدث', 'تحديد العوامل المساهمة', 'تحليل السبب', 'مراجعة الوثائق', 'المقابلات والملاحظة الميدانية', 'مقارنة النتائج قبل وبعد التطبيق', 'المقارنة بالمعايير', 'المرجعية المحلية', 'المرجعية الدولية'] },
  { style: 'rich', icon: '/assets/visual-library/icon-policy-institution-shield.webp', terms: ['دعم مؤسسي', 'الشمولية', 'حماية السرّية', 'السرية المهنية', 'السرية والأمانة', 'حماية الحقوق', 'حماية حقوق', 'القوانين واللوائح المحلية', 'المعايير الدولية', 'الجهات الإشرافية', 'نظام النضج الرقمي', 'التصنيف الدولي', 'إصدار المعايير واللوائح', 'الدعم الفني والإرشادي', 'برنامج تحول القطاع الصحي', 'صانع السياسة الصحية', 'المشغّل الاستراتيجي', 'تكافؤ الفرص', 'وضوح الاشتراطات والمعايير', 'منع التمييز غير المبرر', 'منع الاحتكار', 'حيادية التنظيم', 'الإفصاح العلني'] },
  { style: 'flat', icon: '/assets/visual-library/icon-policy-institution-shield.webp', terms: ['دعم مؤسسي', 'الشمولية', 'حماية السرّية', 'السرية المهنية', 'السرية والأمانة', 'حماية الحقوق', 'حماية حقوق', 'القوانين واللوائح المحلية', 'المعايير الدولية', 'الجهات الإشرافية', 'نظام النضج الرقمي', 'التصنيف الدولي', 'إصدار المعايير واللوائح', 'الدعم الفني والإرشادي', 'برنامج تحول القطاع الصحي', 'صانع السياسة الصحية', 'المشغّل الاستراتيجي', 'تكافؤ الفرص', 'وضوح الاشتراطات والمعايير', 'منع التمييز غير المبرر', 'منع الاحتكار', 'حيادية التنظيم', 'الإفصاح العلني'] },
  { style: 'rich', icon: '/assets/visual-library/icon-policy-presentation-plan.webp', terms: ['رؤية استراتيجية واضحة', 'تصميم خطة', 'خطط استجابة', 'خطط الطوارئ', 'خطة العمل', 'استراتيجية الحل المزدوج', 'الاستجابة الاتصالية العاجلة', 'الاستجابة الفورية', 'الاستعداد والوقاية', 'المرونة', 'السرعة المدروسة', 'إدارة الأزمة', 'دعم استراتيجي', 'تحديد الأهداف والنطاق', 'رصد السلوكيات السوقية'] },
  { style: 'flat', icon: '/assets/visual-library/icon-policy-presentation-plan.webp', terms: ['رؤية استراتيجية واضحة', 'تصميم خطة', 'خطط استجابة', 'خطط الطوارئ', 'خطة العمل', 'استراتيجية الحل المزدوج', 'الاستجابة الاتصالية العاجلة', 'الاستجابة الفورية', 'الاستعداد والوقاية', 'المرونة', 'السرعة المدروسة', 'إدارة الأزمة', 'دعم استراتيجي', 'تحديد الأهداف والنطاق', 'رصد السلوكيات السوقية'] },
  { style: 'rich', icon: '/assets/visual-library/icon-financial-dashboard-analytics.webp', terms: ['تأمين السيارات', 'التأمين الصحي', 'صناديق المعاشات', 'افتراضات اكتوارية دقيقة', 'رفض مطالبة تأمينية', 'مجموعة طبية', 'مركز تجميل', 'التحليل الاقتصادي', 'تقييم البرامج الصحية', 'تقييم المدخلات', 'تقييم مستوى المخاطر', 'تعديل النتائج إحصائيًا', 'قصير الأجل', 'متوسط الأجل', 'طويل الأجل', 'قوائم مالية'] },
  { style: 'flat', icon: '/assets/visual-library/icon-financial-dashboard-analytics.webp', terms: ['تأمين السيارات', 'التأمين الصحي', 'صناديق المعاشات', 'افتراضات اكتوارية دقيقة', 'رفض مطالبة تأمينية', 'مجموعة طبية', 'مركز تجميل', 'التحليل الاقتصادي', 'تقييم البرامج الصحية', 'تقييم المدخلات', 'تقييم مستوى المخاطر', 'تعديل النتائج إحصائيًا', 'قصير الأجل', 'متوسط الأجل', 'طويل الأجل', 'قوائم مالية'] },
  { style: 'rich', icon: '/assets/visual-library/icon-cost-reduction-value.svg', terms: ['هدر', 'تحصيل مبالغ إضافية', 'السعر المعدل بالمخاطر', 'ممرات المخاطر', 'تقسيم الوفر', 'التسعير على أساس الطلب', 'التسعير على أساس المنافسة', 'التسعير المبني على القيمة', 'التسعير مقابل القيمة', 'التسعير التقليدي', 'تسعير الربط', 'تنسيق الأسعار', 'هامش الاستدامة', 'الاستهلاك', 'الأدوات الطبية', 'الأدوية', 'وقت التمريض', 'خسائر غير حقيقية', 'هيكلة الحوافز المالية', 'ربط التمويل بالنتائج الصحية', 'القيمة المحققة', 'القيمة محور كل قرار'] },
  { style: 'flat', icon: '/assets/visual-library/icon-cost-reduction-value.svg', terms: ['هدر', 'تحصيل مبالغ إضافية', 'السعر المعدل بالمخاطر', 'ممرات المخاطر', 'تقسيم الوفر', 'التسعير على أساس الطلب', 'التسعير على أساس المنافسة', 'التسعير المبني على القيمة', 'التسعير مقابل القيمة', 'التسعير التقليدي', 'تسعير الربط', 'تنسيق الأسعار', 'هامش الاستدامة', 'الاستهلاك', 'الأدوات الطبية', 'الأدوية', 'وقت التمريض', 'خسائر غير حقيقية', 'هيكلة الحوافز المالية', 'ربط التمويل بالنتائج الصحية', 'القيمة المحققة', 'القيمة محور كل قرار'] },
  { style: 'rich', icon: '/assets/visual-library/icon-contract-signing.webp', terms: ['مركز التأمين الصحي الوطني', 'عقود الشركات', 'عقود الحزم العلاجية', 'عقود الشبكة', 'نموذج ACO', 'نماذج التعويض', 'الدفع الملائم', 'نموذج الدفع', 'الدفع مقابل الأداء', 'تعرفة', 'التعاقد', 'العقود'] },
  { style: 'flat', icon: '/assets/visual-library/icon-contract-signing.webp', terms: ['مركز التأمين الصحي الوطني', 'عقود الشركات', 'عقود الحزم العلاجية', 'عقود الشبكة', 'نموذج ACO', 'نماذج التعويض', 'الدفع الملائم', 'نموذج الدفع', 'الدفع مقابل الأداء', 'تعرفة', 'التعاقد', 'العقود'] },
  { style: 'rich', icon: '/assets/visual-library/icon-handshake-negotiation-growth.webp', terms: ['التفاوض', 'التعاون', 'التسوية', 'المنافسة', 'التكيّف', 'التجنّب', 'تقليل المخاطر', 'قبول المخاطر', 'نقل المخاطر', 'تجنّب المخاطر', 'تقاسم المخاطر', 'التوازن بين الكفاءة والإتاحة', 'دعم المنافسة العادلة', 'التمييز بين مقدّمي الخدمة', 'دعم بيئة سوقية مستقرة', 'تمكين القطاع الخاص'] },
  { style: 'flat', icon: '/assets/visual-library/icon-handshake-negotiation-growth.webp', terms: ['التفاوض', 'التعاون', 'التسوية', 'المنافسة', 'التكيّف', 'التجنّب', 'تقليل المخاطر', 'قبول المخاطر', 'نقل المخاطر', 'تجنّب المخاطر', 'تقاسم المخاطر', 'التوازن بين الكفاءة والإتاحة', 'دعم المنافسة العادلة', 'التمييز بين مقدّمي الخدمة', 'دعم بيئة سوقية مستقرة', 'تمكين القطاع الخاص'] },
  { style: 'rich', icon: '/assets/visual-library/icon-policy-document-check-light.webp', terms: ['الموقف', 'الخلفية', 'التقييم', 'التوصية', 'تقارير مجلس الإدارة', 'تقارير الإدارة التنفيذية', 'تقارير الأقسام الطبية', 'ملخص تنفيذي', 'النتائج التفصيلية', 'الاستنتاجات العامة', 'وصف المشكلة أو الحالة', 'النتائج والتوصيات', 'تسجيل الانحرافات والتعديلات', 'تجميع المعلومات', 'التعلّم من الأخطاء بدل إخفائها', 'التعرف على المشكلة'] },
  { style: 'flat', icon: '/assets/visual-library/icon-file-report.webp', terms: ['الموقف', 'الخلفية', 'التقييم', 'التوصية', 'تقارير مجلس الإدارة', 'تقارير الإدارة التنفيذية', 'تقارير الأقسام الطبية', 'ملخص تنفيذي', 'النتائج التفصيلية', 'الاستنتاجات العامة', 'وصف المشكلة أو الحالة', 'النتائج والتوصيات', 'تسجيل الانحرافات والتعديلات', 'تجميع المعلومات', 'التعلّم من الأخطاء بدل إخفائها', 'التعرف على المشكلة'] },
  { style: 'rich', icon: '/assets/visual-library/icon-policy-institution-shield.webp', terms: ['استجابة عادلة', 'الثقافة العادلة', 'التوازن المطلوب', 'إبلاغ سهلة وسرّية', 'دعم القرارات القيادية', 'عوامل السلوك التنظيمي', 'حسب درجة الخطورة', 'حسب مستوى الرعاية', 'اتخاذ قرارات مدروسة', 'الدفاع عن الحقوق وإدارة الشكاوى', 'المكون المهني والفني', 'المستوى الإداري المتوسط', 'أساس علمي موضوعي', 'تقليل الاعتماد على الحدس', 'تحديد المشكلات بدقة', 'نموذج اتخاذ القرار التشاركي', 'الخطأ البشري غير المقصود', 'السلوك المحفوف بالمخاطر', 'السلوك المتعمّد المخالف'] },
  { style: 'flat', icon: '/assets/visual-library/icon-policy-institution-shield.webp', terms: ['استجابة عادلة', 'الثقافة العادلة', 'التوازن المطلوب', 'إبلاغ سهلة وسرّية', 'دعم القرارات القيادية', 'عوامل السلوك التنظيمي', 'حسب درجة الخطورة', 'حسب مستوى الرعاية', 'اتخاذ قرارات مدروسة', 'الدفاع عن الحقوق وإدارة الشكاوى', 'المكون المهني والفني', 'المستوى الإداري المتوسط', 'أساس علمي موضوعي', 'تقليل الاعتماد على الحدس', 'تحديد المشكلات بدقة', 'نموذج اتخاذ القرار التشاركي', 'الخطأ البشري غير المقصود', 'السلوك المحفوف بالمخاطر', 'السلوك المتعمّد المخالف'] },
  { style: 'rich', icon: '/assets/visual-library/icon-failure-investigation-gear.webp', terms: ['المخاطر التشغيلية', 'المخاطر البيئية والصحية', 'مخاطر الكوادر البشرية', 'استخدام التكنولوجيا والأنظمة الذكية', 'الكوارث الطبيعية أو البيئية', 'المخاطر السريرية', 'مخاطر تنظيمية', 'مخاطر سمعة', 'تحديد المخاطر', 'التقليص', 'النقل', 'سيناريو متفائل', 'سيناريو واقعي', 'سيناريو تشاؤمي', 'نقطة التعادل', 'حرجة', 'كبيرة', 'صغيرة', 'داخل النطاق الطبيعي', 'خارج النطاق نحو الأعلى', 'خارج النطاق نحو الأسفل', 'البنية التحتية', 'قرارات إغلاق أو دمج غير مبررة'] },
  { style: 'flat', icon: '/assets/visual-library/icon-failure-investigation-gear.webp', terms: ['المخاطر التشغيلية', 'المخاطر البيئية والصحية', 'مخاطر الكوادر البشرية', 'استخدام التكنولوجيا والأنظمة الذكية', 'الكوارث الطبيعية أو البيئية', 'المخاطر السريرية', 'مخاطر تنظيمية', 'مخاطر سمعة', 'تحديد المخاطر', 'التقليص', 'النقل', 'سيناريو متفائل', 'سيناريو واقعي', 'سيناريو تشاؤمي', 'نقطة التعادل', 'حرجة', 'كبيرة', 'صغيرة', 'داخل النطاق الطبيعي', 'خارج النطاق نحو الأعلى', 'خارج النطاق نحو الأسفل', 'البنية التحتية', 'قرارات إغلاق أو دمج غير مبررة'] },
  { style: 'rich', icon: '/assets/visual-library/icon-policy-presentation-plan.webp', terms: ['تخصيص الموارد', 'الأنظمة التقنية', 'استخدام أدوات التحليل الأساسية', 'نموذج حلّ المشكلات', 'تحليل صحيح يوضح الاتجاهات والفجوات', 'متابعة مستمرة بعد التنفيذ', 'تطبيق نماذج التحسين المستمر', 'التنفيذ (Do)', 'زمن الانتظار الطويل', 'وضع إجراءات تصحيحية ووقائية', 'نقص التواصل بين الأقسام الحرجة', 'التدريب والمحاكاة', 'العمل الجماعي الداعم', 'الإبلاغ بدون عقاب', 'اعتماد أفضل الممارسات المكتشفة', 'العمليات الانتخابية', 'تحديد الهدف الصحي', 'تحديد سقف المسؤولية'] },
  { style: 'flat', icon: '/assets/visual-library/icon-policy-presentation-plan.webp', terms: ['تخصيص الموارد', 'الأنظمة التقنية', 'استخدام أدوات التحليل الأساسية', 'نموذج حلّ المشكلات', 'تحليل صحيح يوضح الاتجاهات والفجوات', 'متابعة مستمرة بعد التنفيذ', 'تطبيق نماذج التحسين المستمر', 'التنفيذ (Do)', 'زمن الانتظار الطويل', 'وضع إجراءات تصحيحية ووقائية', 'نقص التواصل بين الأقسام الحرجة', 'التدريب والمحاكاة', 'العمل الجماعي الداعم', 'الإبلاغ بدون عقاب', 'اعتماد أفضل الممارسات المكتشفة', 'العمليات الانتخابية', 'تحديد الهدف الصحي', 'تحديد سقف المسؤولية'] },
  { style: 'rich', icon: '/assets/visual-library/icon-cost-reduction-value.svg', terms: ['الأثر المالي', 'تحديد تكلفة البرنامج', 'حساب القيمة الصافية', 'توحيد البيانات المالية والطبية', 'الاستثمار في الوقاية', 'من المخاطر إلى القيمة', 'شرح معادلة القيمة', 'دمج المالي بالتشغيلي', 'القرار لا يُبنى على مؤشر واحد', 'أقل من 20%', '20% – 30%', '30% – 40%', 'شرح مبادئ التسعير الاستراتيجي والقيمة', 'الارتباط بالقيمة المقدَّمة'] },
  { style: 'flat', icon: '/assets/visual-library/icon-cost-reduction-value.svg', terms: ['الأثر المالي', 'تحديد تكلفة البرنامج', 'حساب القيمة الصافية', 'توحيد البيانات المالية والطبية', 'الاستثمار في الوقاية', 'من المخاطر إلى القيمة', 'شرح معادلة القيمة', 'دمج المالي بالتشغيلي', 'القرار لا يُبنى على مؤشر واحد', 'أقل من 20%', '20% – 30%', '30% – 40%', 'شرح مبادئ التسعير الاستراتيجي والقيمة', 'الارتباط بالقيمة المقدَّمة'] },
  { style: 'rich', icon: '/assets/visual-library/icon-policy-institution-shield.webp', terms: ['التنحي', 'التنازل', 'المراقبة', 'الفلتر الأخلاقي', 'الفلتر التنظيمي', 'التجزئة', 'طبيب وشركة دواء', 'مدير مشتريات وقريبه', 'جراح ومكافآت الكمية', 'الشفافية العامة', 'الشفافية في إفصاح النتائج', 'قابلية القرار للمراجعة', 'قواعد واضحة للصرف والاعتماد', 'الفصل بين الموافقة والمراجعة', 'الشفافية', 'المساءلة', 'التفسير واتخاذ القرار'] },
  { style: 'flat', icon: '/assets/visual-library/icon-policy-institution-shield.webp', terms: ['التنحي', 'التنازل', 'المراقبة', 'الفلتر الأخلاقي', 'الفلتر التنظيمي', 'التجزئة', 'طبيب وشركة دواء', 'مدير مشتريات وقريبه', 'جراح ومكافآت الكمية', 'الشفافية العامة', 'الشفافية في إفصاح النتائج', 'قابلية القرار للمراجعة', 'قواعد واضحة للصرف والاعتماد', 'الفصل بين الموافقة والمراجعة', 'الشفافية', 'المساءلة', 'التفسير واتخاذ القرار'] },
  { style: 'rich', icon: '/assets/visual-library/icon-performance-chart.webp', terms: ['المستوى التشغيلي', 'الأثر التشغيلي', 'عبء عمل يتجاوز القدرة التشغيلية', 'تباين النتائج بين منشآت متشابهة'] },
  { style: 'flat', icon: '/assets/visual-library/icon-performance-chart.webp', terms: ['المستوى التشغيلي', 'الأثر التشغيلي', 'عبء عمل يتجاوز القدرة التشغيلية', 'تباين النتائج بين منشآت متشابهة'] },
  { style: 'rich', icon: '/assets/visual-library/icon-quality-cycle-badge.webp', terms: ['تقييم وترتيب', 'الملاءمة', 'الاستدامة', 'خط الأساس'] },
  { style: 'flat', icon: '/assets/visual-library/icon-quality-cycle-badge.webp', terms: ['تقييم وترتيب', 'الملاءمة', 'الاستدامة', 'خط الأساس'] },
  { style: 'rich', icon: '/assets/visual-library/icon-policy-presentation-plan.webp', terms: ['إهمال حالات غير مشمولة', 'الشراء الاستراتيجي', 'البُعد التشغيلي', 'الإرهاق والضغط المهني', 'ترتيب الأولويات حسب احتمال الضرر وشدته', 'التعلم من الأخطاء بدل إخفائها'] },
  { style: 'flat', icon: '/assets/visual-library/icon-policy-presentation-plan.webp', terms: ['إهمال حالات غير مشمولة', 'الشراء الاستراتيجي', 'البُعد التشغيلي', 'الإرهاق والضغط المهني', 'ترتيب الأولويات حسب احتمال الضرر وشدته', 'التعلم من الأخطاء بدل إخفائها'] },
  { style: 'rich', icon: '/assets/visual-library/icon-patient-safety-heart-check.webp', terms: ['سلامة المرضى', 'ثقافة السلامة', 'الرعاية الآمنة', 'عدم الإيذاء', 'مخاطر سلامة المرضى', 'الأداء السريري', 'جودة العلاج وسلامة المريض'] },
  { style: 'flat', icon: '/assets/visual-library/icon-patient-safety-heart-check.webp', terms: ['سلامة المرضى', 'ثقافة السلامة', 'الرعاية الآمنة', 'عدم الإيذاء', 'مخاطر سلامة المرضى', 'الأداء السريري', 'جودة العلاج وسلامة المريض'] },
  { style: 'rich', icon: '/assets/visual-library/icon-patient-safety-team-circle.webp', terms: ['فريق الرعاية', 'تواصل مفتوح', 'عمل جماعي', 'مشاركة المرضى', 'تجربة المرضى', 'تجربة المريض', 'PROMs', 'PREMs', 'المستفيدون'] },
  { style: 'flat', icon: '/assets/visual-library/icon-patient-safety-team-circle.webp', terms: ['فريق الرعاية', 'تواصل مفتوح', 'عمل جماعي', 'مشاركة المرضى', 'تجربة المرضى', 'تجربة المريض', 'PROMs', 'PREMs', 'المستفيدون'] },
  { style: 'rich', icon: '/assets/visual-library/icon-failure-investigation-gear.webp', terms: ['إدارة حالات الإخفاق', 'إخفاق', 'الإخفاقات', 'سبب جذري', 'الأسباب الجذرية', 'تحليل السبب الجذري', 'RCA', 'حوادث', 'حادث دوائي', 'العوامل البشرية'] },
  { style: 'flat', icon: '/assets/visual-library/icon-failure-investigation-gear.webp', terms: ['إدارة حالات الإخفاق', 'إخفاق', 'الإخفاقات', 'سبب جذري', 'الأسباب الجذرية', 'تحليل السبب الجذري', 'RCA', 'حوادث', 'حادث دوائي', 'العوامل البشرية'] },
  { style: 'rich', icon: '/assets/visual-library/icon-quality-cycle-badge.webp', terms: ['تحسين مستمر', 'دورة PDCA', 'PDCA', 'PDSA', 'Lean', 'Six Sigma', 'DMAIC', 'التحسين أو الإجراء التصحيحي', 'مراجعات ما بعد الحدث', 'التعلم المستمر'] },
  { style: 'flat', icon: '/assets/visual-library/icon-quality-cycle-badge.webp', terms: ['تحسين مستمر', 'دورة PDCA', 'PDCA', 'PDSA', 'Lean', 'Six Sigma', 'DMAIC', 'التحسين أو الإجراء التصحيحي', 'مراجعات ما بعد الحدث', 'التعلم المستمر'] },
  { style: 'rich', icon: '/assets/visual-library/icon-kpi-dashboard.webp', terms: ['لوحة معلومات', 'لوحات المعلومات', 'Dashboard', 'مؤشرات الأداء', 'مؤشرات النتائج', 'مؤشرات العمليات', 'مؤشرات استراتيجية', 'مؤشرات تشغيلية', 'مؤشرات مالية', 'تصوير البيانات'] },
  { style: 'flat', icon: '/assets/visual-library/icon-kpi-dashboard.webp', terms: ['لوحة معلومات', 'لوحات المعلومات', 'Dashboard', 'مؤشرات الأداء', 'مؤشرات النتائج', 'مؤشرات العمليات', 'مؤشرات استراتيجية', 'مؤشرات تشغيلية', 'مؤشرات مالية', 'تصوير البيانات'] },
  { style: 'rich', icon: '/assets/visual-library/icon-performance-chart.webp', terms: ['تحليل الاتجاهات', 'اتجاهات الأداء', 'قياس الأثر', 'تحليل الأداء', 'الأداء المالي', 'الأداء التشغيلي', 'الأداء والتقارير', 'قائمة الدخل'] },
  { style: 'flat', icon: '/assets/visual-library/icon-performance-chart.webp', terms: ['تحليل الاتجاهات', 'اتجاهات الأداء', 'قياس الأثر', 'تحليل الأداء', 'الأداء المالي', 'الأداء التشغيلي', 'الأداء والتقارير', 'قائمة الدخل'] },
  { style: 'rich', icon: '/assets/visual-library/icon-financial-dashboard-analytics.webp', terms: ['التنبؤ الاكتواري', 'تعديل المخاطر', 'النمذجة الاكتوارية', 'التحليل الاكتواري', 'التحليل المالي', 'القوائم المالية', 'التنبؤ المالي', 'قائمة المركز المالي', 'قائمة التدفقات النقدية', 'التحليل الاقتصادي والمالي'] },
  { style: 'flat', icon: '/assets/visual-library/icon-financial-dashboard-analytics.webp', terms: ['التنبؤ الاكتواري', 'تعديل المخاطر', 'النمذجة الاكتوارية', 'التحليل الاكتواري', 'التحليل المالي', 'القوائم المالية', 'التنبؤ المالي', 'قائمة المركز المالي', 'قائمة التدفقات النقدية', 'التحليل الاقتصادي والمالي'] },
  { style: 'rich', icon: '/assets/visual-library/icon-cost-reduction-value.svg', terms: ['التكلفة', 'التكاليف', 'خفض التكلفة', 'خفض التكاليف', 'تقليل الهدر', 'كفاءة التسعير', 'تكلفة متغيرة', 'تكلفة ثابتة', 'تكلفة شبه متغيرة', 'التسعير الصحي', 'تسعير الإفراط', 'هامش الربح', 'العائد على الاستثمار', 'تحليل الأثر الاقتصادي', 'القيمة مقابل التكلفة'] },
  { style: 'flat', icon: '/assets/visual-library/icon-cost-reduction-value.svg', terms: ['التكلفة', 'التكاليف', 'خفض التكلفة', 'خفض التكاليف', 'تقليل الهدر', 'كفاءة التسعير', 'تكلفة متغيرة', 'تكلفة ثابتة', 'تكلفة شبه متغيرة', 'التسعير الصحي', 'تسعير الإفراط', 'هامش الربح', 'العائد على الاستثمار', 'تحليل الأثر الاقتصادي', 'القيمة مقابل التكلفة'] },
  { style: 'rich', icon: '/assets/visual-library/icon-contract-signing.webp', terms: ['التعاقد', 'العقود', 'مراجعة العقود', 'أنواع العقود', 'نماذج التعاقد', 'تعرفة الخدمات', 'المدفوعات المجمّعة', 'الدفعات المقطوعة', 'الدفع مقابل الأداء', 'أنظمة الدفع والتعويض'] },
  { style: 'flat', icon: '/assets/visual-library/icon-contract-signing.webp', terms: ['التعاقد', 'العقود', 'مراجعة العقود', 'أنواع العقود', 'نماذج التعاقد', 'تعرفة الخدمات', 'المدفوعات المجمّعة', 'الدفعات المقطوعة', 'الدفع مقابل الأداء', 'أنظمة الدفع والتعويض'] },
  { style: 'rich', icon: '/assets/visual-library/icon-handshake-negotiation-growth.webp', terms: ['التفاوض', 'الشراكة', 'الشراكات', 'تقاسم المخاطر', 'موازين القوى', 'التفاوض القائم على القيمة', 'أصحاب المصلحة', 'الشركاء الاستراتيجيون', 'الشركاء التشغيليون'] },
  { style: 'flat', icon: '/assets/visual-library/icon-handshake-negotiation-growth.webp', terms: ['التفاوض', 'الشراكة', 'الشراكات', 'تقاسم المخاطر', 'موازين القوى', 'التفاوض القائم على القيمة', 'أصحاب المصلحة', 'الشركاء الاستراتيجيون', 'الشركاء التشغيليون'] },
  { style: 'rich', icon: '/assets/visual-library/icon-bank-vault-safe.webp', terms: ['الاستدامة المالية', 'الاحتياطيات', 'استدامة التمويل', 'تنويع مصادر التمويل', 'بناء الاحتياطيات', 'المخصصات', 'السيولة', 'الاستدامة لا الربح'] },
  { style: 'flat', icon: '/assets/visual-library/icon-bank-vault-safe.webp', terms: ['الاستدامة المالية', 'الاحتياطيات', 'استدامة التمويل', 'تنويع مصادر التمويل', 'بناء الاحتياطيات', 'المخصصات', 'السيولة', 'الاستدامة لا الربح'] },
  { style: 'rich', icon: '/assets/visual-library/icon-policy-institution-shield.webp', terms: ['الحوكمة', 'الإطار التنظيمي', 'الجهة التنظيمية', 'وزارة الصحة', 'سباهي', 'المجلس الصحي', 'المركز السعودي لاعتماد المنشآت الصحية', 'هيئة الغذاء والدواء', 'المرسوم الملكي'] },
  { style: 'flat', icon: '/assets/visual-library/icon-policy-institution-shield.webp', terms: ['الحوكمة', 'الإطار التنظيمي', 'الجهة التنظيمية', 'وزارة الصحة', 'سباهي', 'المجلس الصحي', 'المركز السعودي لاعتماد المنشآت الصحية', 'هيئة الغذاء والدواء', 'المرسوم الملكي'] },
  { style: 'rich', icon: '/assets/visual-library/icon-policy-document-check-light.webp', terms: ['السياسات', 'البروتوكولات', 'السجلات', 'التقارير', 'تقرير', 'توثيق', 'وثائق', 'CAPA', 'SBAR', 'الموافقة المستنيرة'] },
  { style: 'flat', icon: '/assets/visual-library/icon-policy-document-check-light.webp', terms: ['السياسات', 'البروتوكولات', 'السجلات', 'التقارير', 'تقرير', 'توثيق', 'وثائق', 'CAPA', 'SBAR', 'الموافقة المستنيرة'] },
  { style: 'rich', icon: '/assets/visual-library/icon-policy-institution-shield.webp', terms: ['الأخلاقيات', 'العدالة', 'الحياد', 'الاستقلالية', 'الإحسان', 'تضارب المصالح', 'النزاهة', 'الشفافية والمساءلة', 'التنافسية العادلة'] },
  { style: 'flat', icon: '/assets/visual-library/icon-policy-institution-shield.webp', terms: ['الأخلاقيات', 'العدالة', 'الحياد', 'الاستقلالية', 'الإحسان', 'تضارب المصالح', 'النزاهة', 'الشفافية والمساءلة', 'التنافسية العادلة'] },
  // Round-2 exact-title overrides: the scene-icon -> flat-icon pool swap
  // (removing the 8 isometric "scene" images from per-card rotation, so a
  // shot never mixes flat icons with photo-style illustrations) shrank the
  // per-style pool enough that 18 new within-shot repeats surfaced. Each of
  // these titles was landing on the same image as a sibling card in its own
  // shot; checked first (array order) so they always win their own icon.
  { style: 'rich', icon: '/assets/visual-library/icon-policy-books-magnifier-compare.webp', terms: ['تحليل الشكاوى والملاحظات'] },
  { style: 'rich', icon: '/assets/visual-library/icon-policy-time-person-ribbon.webp', terms: ['تمكين المرضى من تقديم الشكاوى'] },
  { style: 'rich', icon: '/assets/visual-library/icon-policy-time-person-ribbon.webp', terms: ['المستفيدون'] },
  { style: 'rich', icon: '/assets/visual-library/icon-policy-book-write.webp', terms: ['وضع جدول زمني واضح'] },
  { style: 'rich', icon: '/assets/visual-library/icon-policy-books-magnifier-compare.webp', terms: ['الأثر التنظيمي'] },
  { style: 'rich', icon: '/assets/visual-library/icon-policy-time-person-ribbon.webp', terms: ['دعم المنافسة العادلة'] },
  { style: 'rich', icon: '/assets/visual-library/icon-policy-book-magnifier-research.webp', terms: ['التمييز بين مقدّمي الخدمة'] },
  { style: 'flat', icon: '/assets/visual-library/icon-policy-document-check-light.webp', terms: ['مراجعة الوثائق والسجلات'] },
  { style: 'flat', icon: '/assets/visual-library/icon-quality-target-clipboard.webp', terms: ['أدوات تحليل الأداء'] },
  { style: 'rich', icon: '/assets/visual-library/icon-policy-book-magnifier-research.webp', terms: ['الإخفاقات التنظيمية'] },
  { style: 'rich', icon: '/assets/visual-library/icon-policy-scroll-pen-check.webp', terms: ['الإخفاقات التقنية'] },
  { style: 'flat', icon: '/assets/visual-library/icon-quality-checklist-clock.webp', terms: ['قابلية التتبع'] },
  { style: 'rich', icon: '/assets/visual-library/icon-policy-education-shield.webp', terms: ['تسجيل الانحرافات والتعديلات'] },
  { style: 'flat', icon: '/assets/visual-library/icon-policy-analytics-search.webp', terms: ['الموارد'] },
  { style: 'flat', icon: '/assets/visual-library/icon-file-report.webp', terms: ['الجدول الزمني'] },
  { style: 'flat', icon: '/assets/visual-library/icon-quality-target-clipboard.webp', terms: ['أكثر من 40%'] },
  { style: 'flat', icon: '/assets/visual-library/icon-quality-target-clipboard.webp', terms: ['المتابعة'] },
  { style: 'flat', icon: '/assets/visual-library/icon-quality-target-clipboard.webp', terms: ['التركيز على الهدف'] },
  { style: 'flat', icon: '/assets/visual-library/icon-decision-question-arrows.webp', terms: ['التركيز على اتخاذ القرار'] },
  { style: 'rich', icon: '/assets/visual-library/icon-policy-checklist-clipboard.webp', terms: ['الكفاءة'] },
  { style: 'rich', icon: '/assets/visual-library/icon-policy-scroll-pen-check.webp', terms: ['القبول'] },
  { style: 'rich', icon: '/assets/visual-library/icon-policy-checklist-clipboard.webp', terms: ['عدم الإيذاء'] },
  { style: 'rich', icon: '/assets/visual-library/icon-policy-books-magnifier-compare.webp', terms: ['الفعالية'] },
  { style: 'rich', icon: '/assets/visual-library/icon-policy-education-shield.webp', terms: ['العدالة في الوصول'] },
  { style: 'rich', icon: '/assets/visual-library/icon-policy-book-magnifier-research.webp', terms: ['تعزيز الوقاية'] },
  { style: 'rich', icon: '/assets/visual-library/icon-policy-time-person-ribbon.webp', terms: ['تنويع مصادر التمويل'] },
  { style: 'rich', icon: '/assets/visual-library/icon-policy-scroll-pen-check.webp', terms: ['الشراكة مع القطاع الخاص'] },
  { style: 'rich', icon: '/assets/visual-library/icon-policy-book-magnifier-research.webp', terms: ['توثيق إجراءات الصرف'] },
  { style: 'rich', icon: '/assets/visual-library/icon-policy-education-shield.webp', terms: ['ضمان العدالة والاتساق'] },
  { style: 'flat', icon: '/assets/visual-library/icon-policy-analytics-search.webp', terms: ['غرفة العمليات'] },
  { style: 'flat', icon: '/assets/visual-library/icon-policy-document-check-light.webp', terms: ['استدامة مقدّم الخدمة'] },
  { style: 'flat', icon: '/assets/visual-library/icon-quality-target-clipboard.webp', terms: ['أثر السياسات على الأداء المالي'] },
  { style: 'rich', icon: '/assets/visual-library/icon-policy-book-magnifier-research.webp', terms: ['العدالة'] },
  ...
  { style: 'rich', icon: '/assets/visual-library/icon-policy-book-write.webp', terms: ['المقابلات ومجموعات النقاش', 'رفاه الممارس الصحي'] },
  { style: 'flat', icon: '/assets/visual-library/icon-policy-institution-shield.webp', terms: ['الموضوعية والحياد'] },
  { style: 'flat', icon: '/assets/visual-library/icon-quality-target-clipboard.webp', terms: ['التركيز على التحسين', 'مخاطر سيبرانية'] },
  { style: 'flat', icon: '/assets/visual-library/icon-policy-document-check-light.webp', terms: ['السرية والأمانة', 'مخاطر تنظيمية'] },
  { style: 'flat', icon: '/assets/visual-library/icon-policy-stakeholder-people.webp', terms: ['المقابلات والملاحظة الميدانية', 'قياس المخرجات بسؤال المريض مباشرة'] },
  { style: 'flat', icon: '/assets/visual-library/icon-decision-question-arrows.webp', terms: ['البحث المستمر عن فرص التحسين'] },
  { style: 'flat', icon: '/assets/visual-library/icon-quality-checklist-clock.webp', terms: ['استخدام البيانات في اتخاذ القرار'] },
  ...
  { style: 'rich', icon: '/assets/visual-library/icon-policy-checklist-clipboard.webp', terms: ['التركيز على التحسين لا العقاب فقط', 'إدارة حالات الإخفاق'] },
  ...
  { style: 'rich', icon: '/assets/visual-library/icon-policy-education-shield.webp', terms: ['معرفة الأنظمة والسياسات الوطنية'] },
  ...
  { style: 'rich', icon: '/assets/visual-library/icon-policy-checklist-clipboard.webp', terms: ['قياس الأثر على مؤشرات الأداء'] },
  ...
  { style: 'rich', icon: '/assets/visual-library/icon-policy-book-magnifier-research.webp', terms: ['خفض التكاليف'] },
  ...
  { style: 'rich', icon: '/assets/visual-library/icon-policy-education-shield.webp', terms: ['حقوق المرضى', 'سلامة المرضى', 'كرامة المريض', 'المريض', 'المرضى'] },
  { style: 'rich', icon: '/assets/visual-library/icon-policy-time-person-ribbon.webp', terms: ['الكادر الطبي', 'فريق طبي', 'فريق الرعاية', 'أصحاب المصلحة الصحيين'] },
  { style: 'rich', icon: '/assets/visual-library/icon-policy-book-write.webp', terms: ['ورشة عمل', 'محاكاة', 'عرض تقديمي', 'تعارف'] },
  { style: 'rich', icon: '/assets/visual-library/icon-policy-checklist-clipboard.webp', terms: ['تحسين مستمر', 'دورة PDCA', 'خطّط-نفّذ-تحقّق-حسّن', 'Lean', 'Six Sigma', 'DMAIC'] },
  ...
  { style: 'flat', icon: '/assets/visual-library/icon-policy-institution-shield.webp', terms: ['إنذار', 'تنبيه', 'مستويات التصعيد', 'انحراف عن المعايير'] },
  ...
  { style: 'rich', icon: '/assets/visual-library/icon-policy-book-magnifier-research.webp', terms: ['التكلفة الدقيقة', 'هامش الربح', 'تسعير الخدمة', 'تحديد التعرفة'] },
  { style: 'rich', icon: '/assets/visual-library/icon-policy-book-magnifier-research.webp', terms: ['التحليل المالي', 'القوائم المالية', 'المؤشرات المالية', 'التنبؤ المالي', 'الأداء المالي'] },
  ...
  { style: 'rich', icon: '/assets/visual-library/icon-policy-scroll-pen-check.webp', terms: ['التعاقد', 'العقود', 'مراجعة العقود', 'أنواع العقود', 'نماذج التعاقد'] },
  { style: 'rich', icon: '/assets/visual-library/icon-policy-books-magnifier-compare.webp', terms: ['الاستدامة المالية', 'الاحتياطيات', 'استقرار السوق', 'استدامة التمويل'] },
  ...
  { style: 'rich', icon: '/assets/visual-library/icon-policy-book-magnifier-research.webp', terms: ['المشغّل الاستراتيجي', 'الدفعات المقطوعة', 'قائمة التدفقات النقدية', 'الممول'] },
  { style: 'rich', icon: '/assets/visual-library/icon-policy-time-person-ribbon.webp', terms: ['مقدّمو الخدمات', 'المقدّم', 'تحسين صحة المجتمع'] },
  ...
  { style: 'rich', icon: '/assets/visual-library/icon-policy-books-magnifier-compare.webp', terms: ['قابلية القرار للمراجعة', 'تسعير الربط'] },
  ...
  { style: 'rich', icon: '/assets/visual-library/icon-policy-education-shield.webp', terms: ['مخاطر إكلينيكية', 'الإحسان', 'تجربة المريض'] },
  ...
  { style: 'rich', icon: '/assets/visual-library/icon-policy-stakeholder-people.webp', terms: ['مجلس الضمان الصحي', 'تنسيق الأسعار'] },
  ...
  { style: 'rich', icon: '/assets/visual-library/icon-policy-book-write.webp', terms: ['رفاه ممارس الرعاية الصحية'] },
  // rich bucket
...
function PptCardView({
  ...
  isCourse1?: boolean;
  /** From policyGov2Marker(slide.id) -- empty for every other course. A
   *  card whose own text has no strong keyword falls back to the one
...
function slideVisualPool(slide: Slide, cards: PptCard[]) {
  ...
  // pool instead.
  const courseMarker = isPolicyGov2Slide ? policyGov2Marker(slide.id) : isEmergencySlide ? ' __bag2__' : '';
      ...
      <div className={`relative grid w-full max-w-[1040px] auto-rows-fr ${cols} ${denseQuadrant ? 'gap-2' : 'gap-2.5'}`}>
        {cards.map((card, index) => {
          ...
          const matrixCardVisuals = isPolicyGov2Slide
            ? pptGeneratedVisualLayersFor(`${card.title} ${card.text ?? ''}${card.bullets?.join(' ') ?? ''}${policyGov2Marker(slide.id)}`, matrixVisualPool[index % matrixVisualPool.length])
            : [];
...
function PptActivitySlide({
  ...
  const cards = slide.ppt?.cards ?? [];
  const isCourse1Slide = slide.audioKey?.endsWith('-course1') ?? false;
  const policyGov2MarkerStr = policyGov2Marker(slide.id);
            ...
            >
              ...
              <span className={`relative grid h-[132px] w-[180px] place-items-center rounded-[28px] border shadow-[0_18px_34px_rgb(24_82_55_/_0.14)] ${
                ...
                {isCourse1Slide ? (
                  ...
                  <img
                    src={pptGeneratedVisualLayersFor(`${currentCard.title} ${currentCard.text ?? ''}${policyGov2MarkerStr}`)[0]}
                    alt=""
...
function PptGuidedScenarioSlide({
  ...
  const isCourse1Slide = slide.audioKey?.endsWith('-course1') ?? false;
  const policyGov2MarkerStr = policyGov2Marker(slide.id);
  const policyGov2Fallback = policyGov2MarkerStr.includes(':flat')
    ? '/assets/visual-library/icon-policy-institution-shield.webp'
    : '/assets/visual-library/icon-policy-scroll-pen-check.webp';
              ...
              <div className="relative z-10 min-h-[164px]">
                {spoken > 0 && (
                  isCourse1Slide ? (
                    ...
                    <img
                      src={pptGeneratedVisualLayersFor(`${scenarioCard.title} ${scenarioCard.text}${policyGov2MarkerStr}`)[0] ?? (policyGov2MarkerStr ? policyGov2Fallback : '/assets/visual-library/audit-controls.webp')}
                      alt=""
          ...
          <div className="pointer-events-auto absolute inset-0 z-[80] flex items-center justify-center p-8">
            ...
            <div className="relative z-10 grid h-[600px] w-full max-w-[1120px] grid-cols-[1fr_0.82fr] overflow-visible rounded-[38px] border border-green-700/18 bg-white shadow-[0_35px_80px_rgb(0_45_28_/_0.24)] animate-scale-in">
              ...
              <div className="relative flex min-h-0 flex-col items-center justify-center bg-green-800 p-8 text-center text-white">
                ...
                <img
                  src={pptGeneratedVisualLayersFor(`${currentCard.title} ${currentCard.text ?? ''}${policyGov2MarkerStr}`)[0] ?? (policyGov2MarkerStr ? policyGov2Fallback : '/assets/visual-library/audit-controls.webp')}
                  alt=""
